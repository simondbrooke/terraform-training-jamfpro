...
08. [Variables and Data](./module_08_variables_and_data.md)
09. [Meta Arguments](./module_09_meta_arguments.md)
10. [Expressions](./module_10_expressions.md)
11. [Terraform State](./module_11_terraform_state.md)
12. [TF Initialization](./module_12_tf_initialization.md)
13. [Writing and Modifying HCL](./module_13_writting_and_modifying_hcl.md)
14. [Plan and Apply](./module_14_plan_and_apply.md)
15. [Resource Drift Management](./module_15_resource_drift_management.md)
16. [State Import and Refresh Operations](./module_16_state_import_and_refresh_operations.md)
17. [Terraform Troubleshooting and Debugging](./module_17_terraform_troubleshooting_and_debugging.md)
...
20. [Publishing and Advanced Module Patterns](./module_20_publishing_and_advanced_module_patterns.md)
21. [Terraform Workflows](./module_21_terraform_workflows.md)
22. [Terraform Backends](./module_22_terraform_backends.md)
23. [Resources and Complex Types](./module_23_resources_and_complex_types.md)
24. [Built-In Functions](./module_24_built_in_functions.md)
25. [Terraform Cloud](./module_25_terraform_cloud.md)
26. [Terraform Workspaces](./module_26_terraform_workspaces.md)
27. [Sentinel Policy as Code](./module_27_sentinel_policy_as_code.md)
28. [HashiCorp Vault Integration](./module_28_hashicorp_vault_integration.md)
